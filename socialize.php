...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "INSERT INTO `posts` (`Post By`, `Title`, `Description`, `Proof`, `date`) VALUES ('$name', '$title', '$desc', '$proof', '$today');";
...
<head>
    ...
    <title>Sportify | Socialize</title>
    <style>
...
<body>
    ...
    <br><br><br><br>
    <center><h1 class="secondary_main">Posts</h1></center>
    ...
    <div class="posts-container">
        ...
        if ($result) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $postBy = htmlspecialchars($row['Post By']);
                ...
                <div class="post-card">
                    ...
                    <p class="post-meta">
                        ...
                        <span class="post-author">by '.$postBy.'</span>
                    </p>
                </div><br><br>';
            }
        } else {
...
<!-- Modal -->
<form action="socialize.php" method="post">
